...
<div class="p-4 sm:p-6 space-y-5" x-data="{ search: '' }">
    ...
    <!-- Header -->
    <div>
        <h2 class="text-xl font-bold">Respaldo de Base de Datos</h2>
        <p class="text-xs dark:text-white/40 text-gray-400 mt-0.5">Administra y descarga copias de seguridad del sistema</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-1 grid grid-cols-3 lg:grid-cols-1 gap-3">
            <div class="stat-card dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 p-4 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-[11px] dark:text-white/40 text-gray-400 mt-0.5">Tablas</p>
                </div>
            </div>
            <div class="stat-card dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 p-4 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-[11px] dark:text-white/40 text-gray-400 mt-0.5">Registros</p>
                </div>
            </div>
            <div class="stat-card dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 p-4 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-[11px] dark:text-white/40 text-gray-400 mt-0.5">Tamaño total</p>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-2 dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 p-6 flex flex-col items-center justify-center text-center">
            ...
            <h3 class="font-semibold mb-1">Descargar Respaldo Completo</h3>
            <p class="text-sm dark:text-white/40 text-gray-400 mb-5 max-w-sm">Genera un archivo .sql con la estructura y datos de todas las tablas de la base de datos</p>
            ...
            <p class="text-[10px] dark:text-white/25 text-gray-300 mt-3">Último respaldo disponible al instante</p>
        </div>
    </div>
    ...
    <div class="dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 overflow-hidden">
        <div class="px-5 py-3.5 border-b dark:border-white/[0.06] border-gray-100 flex items-center justify-between gap-3">
            <h3 class="font-semibold text-sm">Detalle de Tablas</h3>
            <div class="relative">
                ...
                <input type="text" x-model="search" placeholder="Filtrar tabla..." class="w-40 pl-8 pr-3 py-1.5 text-xs rounded-lg dark:bg-white/5 bg-gray-50 border dark:border-white/10 border-gray-200 outline-none focus:border-nexo-500/50">
            </div>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead><tr class="border-b dark:border-white/[0.06] border-gray-100">
                    ...
                    <th class="text-left px-5 py-2.5 text-xs font-medium dark:text-white/40 text-gray-400">Tabla</th>
                    <th class="text-right px-5 py-2.5 text-xs font-medium dark:text-white/40 text-gray-400">Registros</th>
                    <th class="text-right px-5 py-2.5 text-xs font-medium dark:text-white/40 text-gray-400">Tamaño</th>
                    <th class="text-right px-5 py-2.5 text-xs font-medium dark:text-white/40 text-gray-400 hidden sm:table-cell">Motor</th>
                </tr></thead>
                <tbody>
