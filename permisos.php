...
$pageTitle = __('perm_titulo', 'Control de Permisos');
...
// Role configs
$roleConfig = [
    'admin'    => ['label'=>__('perm_rol_admin','Administrador'),'desc'=>__('perm_desc_admin','Acceso completo al sistema'),'color'=>'nexo','bg'=>'bg-nexo-500/10','text'=>'text-nexo-400','border'=>'border-nexo-500/20','dot'=>'bg-nexo-500','icon'=>'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z'],
    'gerente'  => ['label'=>__('perm_rol_gerente','Gerente'),'desc'=>__('perm_desc_gerente','Gestión de equipos y reportes'),'color'=>'blue','bg'=>'bg-blue-500/10','text'=>'text-blue-400','border'=>'border-blue-500/20','dot'=>'bg-blue-500','icon'=>'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
    'vendedor' => ['label'=>__('perm_rol_vendedor','Vendedor'),'desc'=>__('perm_desc_vendedor','Gestión de clientes y ventas'),'color'=>'emerald','bg'=>'bg-emerald-500/10','text'=>'text-emerald-400','border'=>'border-emerald-500/20','dot'=>'bg-emerald-500','icon'=>'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'],
    'soporte'  => ['label'=>__('perm_rol_soporte','Soporte'),'desc'=>__('perm_desc_soporte','Atención y soporte técnico'),'color'=>'amber','bg'=>'bg-amber-500/10','text'=>'text-amber-400','border'=>'border-amber-500/20','dot'=>'bg-amber-500','icon'=>'M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z'],
];

// Module icons
$moduloConfig = [
    'clientes'   => ['icon'=>'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z','label'=>__('perm_mod_clientes','Clientes')],
    'pipeline'   => ['icon'=>'M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7','label'=>__('perm_mod_pipeline','Pipeline')],
    'facturas'   => ['icon'=>'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z','label'=>__('perm_mod_facturas','Facturas')],
    'finanzas'   => ['icon'=>'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z','label'=>__('perm_mod_finanzas','Finanzas')],
    'usuarios'   => ['icon'=>'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z','label'=>__('perm_mod_usuarios','Usuarios')],
    'calendario' => ['icon'=>'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z','label'=>__('perm_mod_calendario','Calendario')],
    'chat'       => ['icon'=>'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z','label'=>__('perm_mod_chat','Chat')],
    'boveda'     => ['icon'=>'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z','label'=>__('perm_mod_boveda','Bóveda')],
    'servicios'  => ['icon'=>'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z','label'=>__('perm_mod_servicios','Servicios')],
    'avisos'     => ['icon'=>'M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z','label'=>__('perm_mod_avisos','Avisos')],
    'actividad'  => ['icon'=>'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2','label'=>__('perm_mod_actividad','Actividad')],
    'backup'     => ['icon'=>'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10','label'=>__('perm_mod_backup','Respaldo')],
    'ajustes'    => ['icon'=>'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0','label'=>__('perm_mod_ajustes','Ajustes')],
    'permisos'   => ['icon'=>'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z','label'=>__('perm_mod_permisos','Permisos')],
];
...
<div x-show="toast" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-2" class="fixed top-20 right-6 z-50 flex items-center gap-3 px-5 py-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 backdrop-blur-sm shadow-lg" x-cloak>
    ...
    <span class="text-sm font-medium text-emerald-400"><?php echo __('perm_guardado'); ?></span>
</div>
...
<div class="p-4 sm:p-6 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl font-bold dark:text-white text-gray-900"><?php echo __('perm_titulo'); ?></h1>
                <p class="text-xs dark:text-white/40 text-gray-400 mt-0.5"><?php echo __('perm_subtitulo'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <div class="dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs dark:text-white/40 text-gray-400"><?php echo __('perm_roles'); ?></p>
        ...
        <div class="dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs dark:text-white/40 text-gray-400"><?php echo __('perm_modulos'); ?></p>
        ...
        <div class="dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs dark:text-white/40 text-gray-400"><?php echo __('perm_activos'); ?></p>
        ...
        <div class="dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs dark:text-white/40 text-gray-400"><?php echo __('perm_cobertura'); ?></p>
        ...
        <div class="px-5 py-4 border-b dark:border-white/[0.06] border-gray-100">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <!-- Quick actions -->
                    <button type="button" onclick="toggleAll('<?php echo htmlspecialchars($rol); ?>', true)" class="text-[11px] font-medium px-2.5 py-1 rounded-lg dark:bg-white/5 bg-gray-100 dark:text-white/50 text-gray-500 dark:hover:bg-white/10 hover:bg-gray-200 transition-colors"><?php echo __('perm_todos'); ?></button>
                    <button type="button" onclick="toggleAll('<?php echo htmlspecialchars($rol); ?>', false)" class="text-[11px] font-medium px-2.5 py-1 rounded-lg dark:bg-white/5 bg-gray-100 dark:text-white/50 text-gray-500 dark:hover:bg-white/10 hover:bg-gray-200 transition-colors"><?php echo __('perm_ninguno'); ?></button>
                </div>
            </div>
        </div>
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b dark:border-white/[0.06] border-gray-100">
                    <th class="text-left px-5 py-3 text-[11px] font-semibold uppercase tracking-wider dark:text-white/30 text-gray-400"><?php echo __('perm_modulo'); ?></th>
    ...
    <div class="flex items-center justify-between dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 px-5 py-4">
        <div class="flex items-center gap-2">
            ...
            <p class="text-xs dark:text-white/30 text-gray-400"><?php echo __('perm_nota'); ?></p>
        </div>
    ...
    <div class="flex flex-wrap items-center gap-4 text-xs dark:text-white/25 text-gray-400 pt-2">
        <span class="font-medium dark:text-white/40 text-gray-500"><?php echo __('perm_roles'); ?>:</span>
        <?php foreach ($roles as $rol):
