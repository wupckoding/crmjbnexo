...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $campos = ['empresa_nombre','empresa_email','empresa_telefono','empresa_direccion','color_primario','logo_url'];
    foreach ($campos as $c) {
        $val = trim($_POST[$c] ?? '');
...
<div class="p-4 sm:p-6 space-y-5" x-data="{ saved: <?php echo isset($msg) ? 'true' : 'false'; ?>, colorVal: '<?php echo htmlspecialchars($config['color_primario'] ?? '#7c3aed'); ?>' }">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-bold">Ajustes Generales</h2>
            <p class="text-xs dark:text-white/40 text-gray-400 mt-0.5">Configura la identidad y apariencia del sistema</p>
        </div>
    </div>
    ...
    <div x-show="saved" x-transition x-init="if(saved) setTimeout(()=> saved = false, 4000)" class="flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-3.5">
        ...
        <p class="text-sm dark:text-emerald-400 text-emerald-600 font-medium">Configuración actualizada correctamente</p>
    </div>
    ...
    <form method="POST" enctype="multipart/form-data" class="space-y-5">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="lg:col-span-2 dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 overflow-hidden">
                <div class="px-5 py-3.5 border-b dark:border-white/[0.06] border-gray-100 flex items-center gap-2.5">
                    ...
                    <h3 class="font-semibold text-sm">Datos de la Empresa</h3>
                </div>
                <div class="p-5 space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label class="text-xs dark:text-white/50 text-gray-500 mb-1.5 block font-medium">Nombre de la Empresa</label>
                            <div class="relative">
                        ...
                        <div>
                            <label class="text-xs dark:text-white/50 text-gray-500 mb-1.5 block font-medium">Email de Contacto</label>
                            <div class="relative">
                        ...
                        <div>
                            <label class="text-xs dark:text-white/50 text-gray-500 mb-1.5 block font-medium">Teléfono</label>
                            <div class="relative">
                        ...
                        <div>
                            <label class="text-xs dark:text-white/50 text-gray-500 mb-1.5 block font-medium">Dirección</label>
                            <div class="relative">
            ...
            <div class="lg:col-span-1 dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 overflow-hidden">
                <div class="px-5 py-3.5 border-b dark:border-white/[0.06] border-gray-100 flex items-center gap-2.5">
                    ...
                    <h3 class="font-semibold text-sm">Logotipo</h3>
                </div>
        ...
        <div class="dark:bg-dark-800 bg-white rounded-2xl border dark:border-white/[0.06] border-gray-200 overflow-hidden">
            <div class="px-5 py-3.5 border-b dark:border-white/[0.06] border-gray-100 flex items-center gap-2.5">
                ...
                <h3 class="font-semibold text-sm">Marca y Apariencia</h3>
            </div>
            <div class="p-5">
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                    <div>
                        <label class="text-xs dark:text-white/50 text-gray-500 mb-1.5 block font-medium">Color Primario</label>
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <p class="text-xs dark:text-white/30 text-gray-400">Vista previa:</p>
        ...
        <div class="flex items-center justify-between pt-1">
            <p class="text-[11px] dark:text-white/20 text-gray-300">Los cambios se aplicarán inmediatamente en todo el sistema.</p>
