...
// Action config
$accionConfig = [
    'crear'       => ['label' => 'Crear',       'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>', 'bg' => 'bg-emerald-500/10 dark:bg-emerald-500/15', 'text' => 'text-emerald-600 dark:text-emerald-400', 'dot' => 'bg-emerald-500'],
    'editar'      => ['label' => 'Editar',      'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>', 'bg' => 'bg-blue-500/10 dark:bg-blue-500/15', 'text' => 'text-blue-600 dark:text-blue-400', 'dot' => 'bg-blue-500'],
    'eliminar'    => ['label' => 'Eliminar',    'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>', 'bg' => 'bg-red-500/10 dark:bg-red-500/15', 'text' => 'text-red-600 dark:text-red-400', 'dot' => 'bg-red-500'],
    'mover'       => ['label' => 'Mover',       'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/>', 'bg' => 'bg-amber-500/10 dark:bg-amber-500/15', 'text' => 'text-amber-600 dark:text-amber-400', 'dot' => 'bg-amber-500'],
    'archivar'    => ['label' => 'Archivar',    'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/>', 'bg' => 'bg-slate-500/10 dark:bg-slate-500/15', 'text' => 'text-slate-600 dark:text-slate-400', 'dot' => 'bg-slate-500'],
    'desarchivar' => ['label' => 'Restaurar',   'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>', 'bg' => 'bg-teal-500/10 dark:bg-teal-500/15', 'text' => 'text-teal-600 dark:text-teal-400', 'dot' => 'bg-teal-500'],
    'asignar'     => ['label' => 'Asignar',     'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>', 'bg' => 'bg-indigo-500/10 dark:bg-indigo-500/15', 'text' => 'text-indigo-600 dark:text-indigo-400', 'dot' => 'bg-indigo-500'],
...
<div class="p-4 sm:p-6 space-y-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            ...
            <p class="text-xs dark:text-white/40 text-gray-400 mt-1">Seguimiento detallado de todas las acciones del sistema</p>
        </div>
        <div class="flex items-center gap-2">
            ...
            <?php endif; ?>
            <span class="text-xs dark:text-white/30 text-gray-400 tabular-nums"><?php echo number_format($total); ?> registros</span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div class="dark:bg-dark-800 bg-white rounded-xl border dark:border-white/[0.06] border-gray-200 p-3.5">
            ...
            <p class="text-[10px] dark:text-white/30 text-gray-400 mt-0.5">eventos registrados</p>
        </div>
        <div class="dark:bg-dark-800 bg-white rounded-xl border dark:border-white/[0.06] border-gray-200 p-3.5">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-[10px] dark:text-white/25 text-gray-300 uppercase tracking-wider">Hoy</span>
            </div>
            <p class="text-2xl font-bold text-emerald-500"><?php echo number_format($statsHoy); ?></p>
            <p class="text-[10px] dark:text-white/30 text-gray-400 mt-0.5">acciones hoy</p>
        </div>
        <div class="dark:bg-dark-800 bg-white rounded-xl border dark:border-white/[0.06] border-gray-200 p-3.5">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-[10px] dark:text-white/25 text-gray-300 uppercase tracking-wider">7 días</span>
            </div>
            <p class="text-2xl font-bold text-blue-500"><?php echo number_format($statsSemana); ?></p>
            <p class="text-[10px] dark:text-white/30 text-gray-400 mt-0.5">última semana</p>
        </div>
        <div class="dark:bg-dark-800 bg-white rounded-xl border dark:border-white/[0.06] border-gray-200 p-3.5">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-[10px] dark:text-white/25 text-gray-300 uppercase tracking-wider">Top</span>
            </div>
            <p class="text-2xl font-bold text-amber-500 capitalize"><?php echo $statsPorAccion[0]['accion'] ?? '—'; ?></p>
            <p class="text-[10px] dark:text-white/30 text-gray-400 mt-0.5">acción más frecuente</p>
        </div>
    </div>
    ...
    <div class="dark:bg-dark-800 bg-white rounded-xl border dark:border-white/[0.06] border-gray-200 p-4">
        <div class="flex items-center justify-between mb-3">
            <p class="text-xs font-medium dark:text-white/50 text-gray-500">Distribución de Acciones</p>
            <p class="text-[10px] dark:text-white/25 text-gray-300"><?php echo count($statsPorAccion); ?> tipos</p>
        </div>
    ...
    <div class="flex flex-wrap items-center gap-2">
        ...
        <form method="get" class="relative flex-1 min-w-[200px] max-w-xs">
            ...
            <input type="text" name="buscar" value="<?php echo htmlspecialchars($_GET['buscar'] ?? ''); ?>" placeholder="Buscar en detalles..." class="w-full pl-9 pr-3 py-2 text-xs rounded-lg dark:bg-white/5 bg-gray-50 border dark:border-white/10 border-gray-200 outline-none focus:border-nexo-500/50 transition-colors">
        </form>
        <!-- Module filter -->
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b dark:border-white/[0.06] border-gray-100">
                    <th class="text-left px-4 py-3 text-[10px] font-semibold uppercase tracking-wider dark:text-white/30 text-gray-400">Fecha & Hora</th>
                    <th class="text-left px-4 py-3 text-[10px] font-semibold uppercase tracking-wider dark:text-white/30 text-gray-400">Usuario</th>
                    <th class="text-left px-4 py-3 text-[10px] font-semibold uppercase tracking-wider dark:text-white/30 text-gray-400">Acción</th>
                    <th class="text-left px-4 py-3 text-[10px] font-semibold uppercase tracking-wider dark:text-white/30 text-gray-400">Módulo</th>
                    <th class="text-left px-4 py-3 text-[10px] font-semibold uppercase tracking-wider dark:text-white/30 text-gray-400">Detalle</th>
                    <th class="text-right px-4 py-3 text-[10px] font-semibold uppercase tracking-wider dark:text-white/30 text-gray-400">IP</th>
                </tr>
            </thead>
            ...
            foreach ($logs as $log):
                ...
                if ($logDate !== $prevDate):
                    $prevDate = $logDate;
                    $dateLabel = $isToday ? 'Hoy' : ($isYesterday ? 'Ayer' : date('d M Y', strtotime($logDate)));
            ?>
            <tr>
            ...
            <tr class="hover:dark:bg-white/[0.02] hover:bg-gray-50/80 transition-colors group">
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center gap-2">
                        ...
                        <?php endif; ?>
                        <span class="text-xs font-medium dark:text-white/80 text-gray-700"><?php echo htmlspecialchars($log['usuario_nombre'] ?? 'Desconocido'); ?></span>
                    </div>
                </td>
                <!-- Action -->
                <td class="px-4 py-3">
            ...
            <tr>
                <td colspan="6" class="px-4 py-12 text-center">
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <p class="text-sm dark:text-white/30 text-gray-400">No se encontraron registros</p>
                        <?php if ($hasFilters): ?><a href="actividad.php" class="text-xs text-nexo-500 hover:underline">Limpiar filtros</a><?php endif; ?>
                    </div>
                </td>
            </tr>
            <?php endif; ?>
    ...
    <div class="flex items-center justify-between">
        <p class="text-[10px] dark:text-white/25 text-gray-400">Página <?php echo $page; ?> de <?php echo $totalPages; ?> &middot; <?php echo number_format($total); ?> registros</p>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-<?php echo count($statsPorModulo); ?> gap-3">
        ...
        <div class="dark:bg-dark-800 bg-white rounded-xl border dark:border-white/[0.06] border-gray-200 p-3.5">
            ...
            <p class="text-[10px] dark:text-white/25 text-gray-300 mt-1.5"><?php echo number_format($sm['cnt']); ?> eventos</p>
        </div>
        <?php endforeach; ?>
    </div>
</div>
